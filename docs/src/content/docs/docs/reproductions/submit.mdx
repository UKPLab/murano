...
1. **Fork the repo and create a branch**
   ...
   Use a short slug that identifies the paper, e.g. `repro/arditi-2024-refusal` or `repro/tmlr2026-shape-happens`.
...
2. **Add your notebook**
   ...
   - Install dependencies in the first code cell (`!pip install murano ...`)
