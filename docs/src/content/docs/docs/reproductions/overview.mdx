...
<LinkButton href="/reproductions/" icon="external">Browse the gallery</LinkButton>
...
<LinkButton href="/docs/reproductions/submit/" icon="right-arrow">Submit a reproduction →</LinkButton>
