...
For multi-step experiments that need validation, caching, and reproducibility, use the pipeline API. The example below trains a refusal direction and evaluates it:
