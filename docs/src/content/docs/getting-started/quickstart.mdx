...
- [Recording Activations](/guides/record/) — token positions, batching, labeled datasets
- [Steering Vectors](/guides/steer/) — how directions are computed and saved
- [Activation Patching](/guides/patch/) — `Intervene` vs `WeightAblation`
- [Probing](/guides/probe/) — train linear classifiers per layer
- [Pipelines](/guides/pipeline/) — validation, multi-phase experiments, custom steps
