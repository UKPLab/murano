...
[![License](https://img.shields.io/github/license/UKPLab/murano)](https://opensource.org/licenses/Apache-2.0)
[![Python Versions](https://img.shields.io/badge/Python-3.9-blue.svg?style=flat&logo=python&logoColor=white)](https://www.python.org/)
[![CI](https://github.com/UKPLab/murano/actions/workflows/main.yml/badge.svg)](https://github.com/UKPLab/murano/actions/workflows/main.yml)
...
To import classes/methods of `murano` from inside the package itself you can use relative imports: 
...
```py
from murano import BaseClass # Notice how I omit the file name
from murano.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `murano` from command line:
